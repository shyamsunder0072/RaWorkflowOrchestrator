...
class PredictOcrTagsHelper(BaseHelper):
    ...
    def get_tags(self, dir_list, bounding_boxes_info, frame_width=640, frame_height=360, batch_size=8,
        ...
        :param bounding_boxes_info: Scene level bounding boxes files.
        ...
        """
        mapped_fn = map_tfserving_model(params.TFServingModels.OPTICAL_CHARACTER_RECOGNITION.value)
        synchronous = True
        return self.run_helper(dir_list, input_extensions,
                               mapped_fn, synchronous,
                               compute_cores=compute_cores,
                               compute_strategy=compute_strategy,
                               bounding_box_info=bounding_boxes_info,
