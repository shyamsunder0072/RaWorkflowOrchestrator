...
"""
    Sound Tags prediction Task Helper.
...
class PredictSoundTagsHelper(BaseHelper):
    """ A wrapper class for using sound tags prediction task helper methods. """
    ...
    def get_tags(self, dir_list,
        ...
        """
        mapped_fn = map_tfserving_model(params.TFServingModels.AUDIO_CLASSIFICATION.value)
        synchronous = True
